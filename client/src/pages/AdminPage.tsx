        ...
        <Card className="p-6 border-2 border-primary space-y-4 bg-gray-900 text-white">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2 space-y-2">
              ...
              <div className="flex space-x-4 mt-1">
                <Badge className="bg-green-500 text-white hover:bg-green-600 text-base font-bold">Casa: {selectedMatch.initialPoolHome.toFixed(2)} USDC</Badge>
                <Badge className="bg-yellow-500 text-black hover:bg-yellow-600 text-base font-bold">Empate: {selectedMatch.initialPoolDraw.toFixed(2)} USDC</Badge>
                <Badge className="bg-red-500 text-white hover:bg-red-600 text-base font-bold">Fora: {selectedMatch.initialPoolAway.toFixed(2)} USDC</Badge>
              </div>
            </div>
          </div>
