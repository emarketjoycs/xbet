...
import { useMatchData, useHousePendingBalance } from '@/hooks/useBettingContract';
...
export default function AdminPage() {
  ...
  const { match: matchData, refetch: refetchMatch } = useMatchData(1); // Exemplo de leitura
  // TODO: Implementar useHousePendingBalance no useBettingContract.ts
  // Por enquanto, vamos simular a leitura para evitar erro de build
  const housePendingBalance = "0.00"; // Substituir por hook real depois
