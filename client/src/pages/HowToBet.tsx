  ...
  const steps = [
    {
      ...
      description: "Use MetaMask, Rabby ou qualquer carteira compatível com WalletConnect. Certifique-se de estar na rede Polygon PoS e ter USDC para apostar e ETH para taxas de gás."
    },
    {
