...
import { useValidatedFutureMatches, FutureMatch as Match } from '@/hooks/useValidatedFutureMatches';
...
export default function GamesPage() {
  ...
  const { matches, isLoading, error, status } = useValidatedFutureMatches();
