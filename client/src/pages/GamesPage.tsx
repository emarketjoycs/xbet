...
export default function GamesPage() {
  ...
  const handleBetClick = (match: Match, outcome: 'home' | 'draw' | 'away') => {
    ...
    const adaptedMatch = {
      ...match,
      odds: {
        home: match.dynamicOddsHome || 0,
        draw: match.dynamicOddsDraw || 0,
        away: match.dynamicOddsAway || 0,
      },
      poolSize: `${((match.realPoolHome || 0) + (match.realPoolDraw || 0) + (match.realPoolAway || 0)).toFixed(2)} USDC`,
      timeRemaining: format(match.startTime, 'HH:mm'),
      betCategories: ['Jogo Todo'], // Categoria padrão
    } as any;
