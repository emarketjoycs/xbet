...
import { Wallet, TrendingUp, Trophy, Clock, ArrowUpRight, ArrowDownLeft, Loader2 } from 'lucide-react';
              ...
              {/* Aviso de Integração */}
	              <div className="mt-6 p-4 bg-primary/10 border border-primary/30 rounded">
	                <p className="text-primary text-xs font-mono leading-relaxed">
	                  Dados mockados. Substitua o hook useUserDashboardData() pela leitura real do seu Smart Contract.
	                </p>
	              </div>
            </Card>
          </div>
