        ...
        <div className="col-span-1 md:col-span-3">
          ...
          <div className="space-y-16 text-gray-300 leading-relaxed">
            ...
            <section id="intro">
              ...
              <p className="mb-4">
                O XBET é um protocolo de apostas peer-to-peer (P2P) construído na rede Polygon PoS. Diferente das casas de apostas tradicionais ("The House"), o XBET atua apenas como um facilitador tecnológico, permitindo que usuários apostem uns contra os outros em um ambiente trustless.
              </p>
              <p>
            ...
            <section id="architecture">
              ...
              <div className="bg-card/50 border border-border p-6 mb-6 font-mono text-sm">
                <ul className="list-disc list-inside space-y-2">
                  <li><span className="text-white font-bold">Rede:</span> Polygon PoS (Layer 2 Ethereum)</li>
