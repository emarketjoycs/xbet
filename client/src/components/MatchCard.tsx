          ...
          <div className="w-full">
            ...
            <div className="flex items-center justify-between gap-4 mb-2">
              <div className="text-center flex-1">
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-1 h-10 flex items-center justify-center truncate px-1" title={match.homeTeam}>{match.homeTeam}</h3>
                <span className="text-xs text-muted-foreground uppercase tracking-widest">Mandante</span>
              </div>
              <div className="text-2xl font-bold text-muted-foreground">VS</div>
              <div className="text-center flex-1">
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-1 h-10 flex items-center justify-center truncate px-1" title={match.awayTeam}>{match.awayTeam}</h3>
